...
/// Nhóm Tâm Sở chính
enum CetasikaGroup {
  @JsonValue('sabbacittasadharana') sabbacittasadharana, // 7 Tâm Sở Biến Hành
  @JsonValue('pakinnaka') pakinnaka,                     // 6 Tâm Sở Biệt Cảnh
  @JsonValue('akusala') akusala,                         // 14 Tâm Sở Bất Thiện
  @JsonValue('sobhana') sobhana,                         // 25 Tâm Sở Tịnh Hảo
}

/// Nhóm Tâm Sở Bất Thiện (phân chi tiết)
enum AkusalaSubGroup {
  @JsonValue('moha_group') mohaGroup,       // Si phần (4): Si, Vô Tàm, Vô Quý, Phóng Dật
  @JsonValue('lobha_group') lobhaGroup,     // Tham phần (3): Tham, Tà Kiến, Ngã Mạn
  @JsonValue('dosa_group') dosaGroup,       // Sân phần (4): Sân, Tật, Lận, Hối
  @JsonValue('thina_group') thinaGroup,     // Hôn Trầm phần (2): Hôn Trầm, Thụy Miên
  @JsonValue('vicikiccha') vicikiccha,      // Hoài Nghi (1)
}

/// Nhóm Tâm Sở Tịnh Hảo (phân chi tiết)
enum SobhanaSubGroup {
  @JsonValue('sobhana_sadharana') sobhanaSadharana,   // 19 Tịnh Hảo Biến Hành
  @JsonValue('viriya_group') viriyaGroup,              // 3 Giới Phần
  @JsonValue('appamanna') appamanna,                   // 2 Vô Lượng Phần
  @JsonValue('panna') panna,                           // 1 Tuệ Phần
}
...
enum ConflictType {
  @JsonValue('pair') pair,       // Cặp đôi (Tham ↔ Vô Tham)
  @JsonValue('triple') triple,   // Bộ 3 (Tham + Sân + Tà Kiến)
  @JsonValue('bhumi') bhumi,     // Bhumi (Tâm Siêu Thế + Sở Dục giới)
  @JsonValue('causal') causal,   // Duyên xung đột (Vô Minh + Trí Tuệ)
}
