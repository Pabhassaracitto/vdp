...
// Header cột dọc cho mỗi Tâm Sở trong Ma Trận
...
class CetasikaHeader extends StatelessWidget {
  ...
  String _getGroupSymbol(CetasikaGroup group) {
    switch (group) {
      case CetasikaGroup.sabbacittasadharana: return VdpSymbols.sabbacittasadharana;
      case CetasikaGroup.pakinnaka: return VdpSymbols.pakinnaka;
      case CetasikaGroup.akusala: return VdpSymbols.cetasikaAkusala;
      case CetasikaGroup.sobhana: return VdpSymbols.cetasikaSobhana;
    }
  }
