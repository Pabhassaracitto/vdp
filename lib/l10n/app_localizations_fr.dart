...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get translationReviewNotice =>
      'Le contenu du Dhamma dans cette langue est une traduction d’étude internationale. Les termes pāḷi font toujours autorité.';

  @override
  String get contentDraftNotice =>
      'Cette traduction est provisoire et en attente de révision doctrinale. Vérifiez-la avec le pāḷi avant de vous y fier.';
