...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get translationReviewNotice =>
      'Содержание Дхаммы на этом языке — международный учебный перевод. Авторитетными остаются термины на пали.';

  @override
  String get contentDraftNotice =>
      'Этот перевод — черновик, ожидающий доктринальной проверки. Сверьтесь с пали, прежде чем на него полагаться.';
